...
const Hero = () => {
  ...
  const ImageContainer = tw.div`absolute w-screen bottom-36 lg:bottom-20 text-center`;
  const AdContainer = tw.div`absolute w-screen bottom-4 lg:bottom-0 h-32 lg:h-16`;
