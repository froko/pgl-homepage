...
const Hero = () => {
  ...
  const ImageContainer = tw.div`absolute w-screen bottom-40 lg:bottom-24 text-center`;
  const AdContainer = tw.div`absolute w-screen bottom-8 lg:bottom-0 h-32 lg:h-16`;
